...
''' Graph File 
    ...
    Changes made: Added heuristic functionalities to graph 

    Description:
        This file contains a graph class.
        Nodes and edges can be added and removed from the graph, an adjacency list can be printed, and a traversal can 
...
class Graph(object):
    def __init__(self, digraph=False):
        ...
        self.nodes_dict = {}
        self.edges_dict = {}
        self.heuristic_dict = {}  # Dictionary where the key is is the node value and the value is the heuristic value
    ...
    def add_heuristic(self, node, heuristic=0):
        self.heuristic_dict[node] = heuristic  # add heuristic value to node value key
